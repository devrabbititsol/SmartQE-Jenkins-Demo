...
public class BaseClass {
	...
	public void validatePDF(WebDriver driver, ExtentReports reports, ExtentTest test) {
		...
		test.log(LogStatus.INFO, "<b style = 'background-color: #ffffff; color : #ff8f00 ; font-size : 18px' ><a href=\"/Reports_TAFAutomation_DR/Reports/"+ReportPaths.reportPathName.replace("html", "pdf")+"\" target=\"_blank\">Input PDF file</a></b>");
		
		try {
		Map<String, String> dataMap = new HashMap<String, String>();
		pdfManager = new PDFManager();
		document = new Document();
		PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("pdfFiles" + File.separator + fileName));
		document.open();
		WebElement departingElement = driver.findElement(By.xpath("//HTML/BODY[1]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/TABLE[1]/TBODY[1]/TR[4]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/TABLE[1]/TBODY[1]/TR[5]/TD[1]/TABLE[1]/TBODY[1]/TR[3]/TD[1]/FONT[1]/B[1]"));
		String departingItem = departingElement.getText();
		dataMap.put("Departing", departingItem);
		
		WebElement returnElement = driver.findElement(By.xpath("//HTML/BODY[1]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/TABLE[1]/TBODY[1]/TR[4]/TD[1]/TABLE[1]/TBODY[1]/TR[1]/TD[2]/TABLE[1]/TBODY[1]/TR[5]/TD[1]/TABLE[1]/TBODY[1]/TR[5]/TD[1]/FONT[1]/B[1]"));
		...
		String confMessage=driver.findElement(By.xpath("//font[contains(text(),'itinerary has been booked')]")).getText();
		...
		String confNumber=driver.findElement(By.xpath("//font[contains(text(),'itinerary has been booked')]/following::b[1]/font")).getText();
		...
		String departingInfo1 = driver.findElement(By.xpath("//font[text()='Departing']/following::b[1]")).getText();
		...
		String returningInfo1 = driver.findElement(By.xpath("//font[text()='Returning']/following::b[1]")).getText();
		...
		String passengerInfo1 = driver.findElement(By.xpath("//b[text()='Passengers']/following::font[1]")).getText();
		document.add(new Paragraph(passengerInfo1.trim()));
		dataMap.put("No of Passengers", passengerInfo1.trim());

		String totalTaxes = driver.findElement(By.xpath("//font[contains(text(),'Taxes:')]/following::b[1]")).getText();
		document.add(new Paragraph("Total Taxes: "+totalTaxes.trim()));
		dataMap.put("Total Taxes", totalTaxes.trim());

		String totalPrice = driver.findElement(By.xpath("//font[contains(text(),'including taxes')]/following::b[1]")).getText();
		...
		String flightBookingData = getFlightData1();
			if (flightBookingData.contains(dataMap.get("Confirmation Message"))) {
				printSuccessLogAndReport(test, null, "Confirmation Message is Displayed in PDF as per Application as : " + dataMap.get("Confirmation Message"));
				//test.log(LogStatus.PASS, "Confirmation Message is Displayed in PDF as per Application as : " + dataMap.get("Confirmation Message"));
			} else {
				printFailureLogAndReport(test,null,"Confirmation Message is NOT Displayed in PDF as per Application");
				//test.log(LogStatus.FAIL, "Confirmation Message is NOT Displayed in PDF as per Application");
			}

		if(flightBookingData.contains(dataMap.get("Confirmation Number"))){
			printSuccessLogAndReport(test, null, "Confirmation Number is Displayed in PDF as per Application as : " + dataMap.get("Confirmation Number"));}
		else{printFailureLogAndReport(test,null, "Confirmation Number is NOT Displayed in PDF as per Application");}

		if(dataMap.get("Departingg") != null && flightBookingData.contains(dataMap.get("Departing"))){
			printSuccessLogAndReport(test, null, "Departing From is Displayed in PDF as per Application as : "+dataMap.get("Departing"));}
		else{printFailureLogAndReport(test,null, "Departing From is NOT Displayed in PDF as per Application");}
		
		if(dataMap.get("Returning")!=null && flightBookingData.contains(dataMap.get("Returning"))){
			printSuccessLogAndReport(test, null, "Returning is Displayed in PDF as per Application as : "+dataMap.get("Returning"));}
		else{printFailureLogAndReport(test,null, "Returning is NOT Displayed in PDF as per Application");}
		
		if(flightBookingData.contains(dataMap.get("No of Passengers"))){
			printSuccessLogAndReport(test, null, "No of Passengers is Displayed in PDF as per Application as : "+dataMap.get("No of Passengers"));}
		else{printFailureLogAndReport(test,null, "No of Passengers is NOT Displayed in PDF as per Application");}
		
		String flightBookingData2 = getFlightData2();
		
		if(flightBookingData2.contains(dataMap.get("Total Taxes"))){
			printSuccessLogAndReport(test, null, "Total Taxes is Displayed in PDF as per Application as : "+dataMap.get("Total Taxes"));}
		else{printFailureLogAndReport(test,null, "Total Taxes is NOT Displayed in PDF as per Application");}
		
		String flightBookingData3 = getFlightData3();
		
		if(flightBookingData3.contains(dataMap.get("Total Price"))){
			printSuccessLogAndReport(test, null, "Total Price is Displayed in PDF as per Application as : "+dataMap.get("Total Price"));}
		else{printFailureLogAndReport(test,null, "Total Price is NOT Displayed in PDF as per Application");}
